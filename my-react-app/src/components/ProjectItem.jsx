...
const ProjectItem = ({img, title, stack, link}) => {
  return (
    <div className='relative flex items-center justify-center h-fit w-full shadow-2xl shadow-[#352137] rounded-xl group hover:bg-gradient-to-r from-[#8d3453] via-[#83348d] to-[#34368d] gradient element-to-rotate'>

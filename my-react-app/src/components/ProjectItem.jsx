...
const ProjectItem = ({img, title, stack, link}) => {
  return (
    <div className='relative flex flex-col overflow-hidden items-center justify-center shadow-lg shadow-[#231823] rounded-xl group hover:bg-gradient-to-r from-[#8d3481] via-[#83348d] to-[#34368d] gradient element-to-rotate'>
